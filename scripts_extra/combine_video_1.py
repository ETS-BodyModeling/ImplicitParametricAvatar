...
def main():
    # video_dir = "/home/fares/ImplicitParametricAvatar/output/output_animation_rotation" 
    # video_dir1= "/home/fares/ImplicitParametricAvatar/output_xavatar_simple/output_animation_rotation"
    video_dir = "/home/fares/ImplicitParametricAvatarRefined/output_simple/output_animation"
    video_dir1= "/home/fares/ImplicitParametricAvatarRefined/output_simple/output_animation"
    output_dir = "/home/fares/ImplicitParametricAvatarRefined/output_simple"
    ...
    for i in range(1996):
        ...
        for path_vid in video_files:
            ...
            if os.path.exists(image_path):
                ...
                if image is not None:
                    resized_image = cv2.resize(image, frame_size0)
                    resized_image = resized_image[:, 40:-40]
        ...
        # # Save combined image for debugging or verification
        # combined_image_path = os.path.join(output_dir, f'combined_frame_{i:04}.png')
