    ...
    for (dirpath, dirnames, filenames) in walk(abs_path):
      ...
      for names in filenames:
        if names.endswith(".obj"):
          ...
          optimizer1 = torch.optim.Adam([t_params,body_pose,global_orient,betas,expression], lr=0.0005) # it was 0.001
          optimizer2 = torch.optim.Adam([t_params,body_pose,global_orient,betas,expression,left_hand_pose,right_hand_pose], lr=0.001) # it was 0.005
...
if __name__ == "__main__":
  ...
  out_path='/home/ext_fares_podform3d_com/test/output/base_1/'
