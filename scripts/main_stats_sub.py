...
if __name__ == "__main__":
    ...
    if data_3d_exists:  
        ...
        moyenne = [0.841,	0.807,	0.876,	0.108,	20.742,	0.911,	0.066,	23.035,	0.979]
        std = [0.00583,	0.00053,	0.00032,	0.00042,	0.02454,	0.00000,	0.00042,	0.05649,	0.00052]
