    ...
    for (dirpath, dirnames, filenames) in walk(abs_path):
      ...
      for names in filenames:
        ...
        #   i=i+1
          ...
          start_time = time.time()
          extract_texture_pifu(pifu_mesh,mesh_f, os.path.join(root_path, args.data_path, 'smplx_uv.obj'),path,uv_size=1024)
...
if __name__ == "__main__":
  ...
  read_dictionary = np.load(os.path.join(root_path, args.data_path, 'index_regularisation.npy') ,allow_pickle='TRUE').item()
